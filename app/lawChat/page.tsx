...
const defaultMessage: ChatMessage = {
  role: 'assistant',
  content: 'Hello! I am your legal counsellor bot. Ask me any question about Indian law.',
};
export default function LawChat() {
  ...
  return (
    <div className="mx-auto h-screen flex flex-col p-4">
      ...
      <div className="flex-1 bg-background p-4 overflow-y-auto space-y-4">
        {messages.map((msg, index) => (
          <div
            key={index}
            className={`p-3 rounded-md border max-w-[80%] ${
              msg.role === 'user'
                ? 'ml-auto bg-background border-border'
                : 'mr-auto bg-background border-border'
            }`}
          >
